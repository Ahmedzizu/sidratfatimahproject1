...
const InsurancesHalls = () => {
  ...
  console.log("الحجوزات المسترجعة من Redux:", halls);

  let data = halls.filter((ele) => ele.type === "hall");
  console.log("البيانات بعد فلترة القاعات:", data);
  ...
  let filteredData = data.filter((ele) => {
    ...
    return sum > 0; // إبقاء الحجوزات التي تحتوي على تأمين فقط
  });
  ...
  console.log("البيانات النهائية بعد كل الفلاتر:", filteredData);
