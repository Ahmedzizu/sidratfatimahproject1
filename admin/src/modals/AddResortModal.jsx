...
function AddResortModal({handleClose,update,data:data2,open}) {    
...
function handleSubmit(e){
  e.preventDefault();
  setLoading(true)
  let url = update? '/admin/resort/update':'/admin/resort'
  Api.post(url, data,{
    headers:{
        ...
        <Box sx={style} className='model'>
          ...
          <form onSubmit={handleSubmit}>
            <Grid container spacing={2}>
                ...
                <Grid item xs={12}>
                    <Button variant='contained' disabled={loading} type='submit' fullWidth style={{backgroundColor:"#B38D46",height:"50px" ,fontSize:"1rem"}}>{loading? "Loading ...":"اضافة"}</Button>
                </Grid>
            </Grid>
          </form>
        </Box>
